...
router.post('/', isAutehnticated, sleepTimeValidationRules(), validate, controller.postSleepTime);
router.put('/:id', isAutehnticated, sleepTimeValidationRules(), validate, controller.updateSleepTime);
